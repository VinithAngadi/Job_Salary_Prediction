...
from sklearn.ensemble import RandomForestRegressor
model_rf = RandomForestRegressor(max_features = 1400, max_depth = 60, n_estimators = 450, random_state = 0)
...
from sklearn import ensemble
gb_reg = ensemble.GradientBoostingRegressor().fit(X_train, y_train)
